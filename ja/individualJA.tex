...
% 縦書きの場合はbox左上である。
%
% \begin{longtable}{lp{.66\textwidth}}
% \meta{box name}|nameX| &
% 配置した人物名の末尾
% \\
%
...
% \caption{child mark}\label{table:cmark}\\
% |\biological|\par|\ftbiological| &
% 人物名の前に実子を意味する実線を描く。
% \\
% \hline
%
% |\adopted|\par|\ftadopted| &
% 人物名の前に養子を意味する二重線を描く。
% \\
% \hline
%
...
%
% \begin{longtable}{p{.25\textwidth}p{.66\textwidth}}
% \caption{属性}\label{table:attrib}\\
% |\haschild|\par|\fthaschild| &
% 子をもうけた配偶者を表す。\par
% 後述する婚姻関係定義に使用すると、婚姻
...
% \hline
%
% |\private|\par|\ftprivate| &
% 法的な婚姻関係ではないことを表す。\par
% 後述する婚姻関係定義に使用する
% と、婚姻関係を意味する二重線を点線にする。
% \\
% \hline
%
% |\maleline|\par|\ftmaleline| &
% 婚姻線を描かず人物名から子への線を描く。\par
% 線の長さはオプション引数|maleline調整|で加減できる。
% |\ftfemaleline|、
% |\ftpatrilineal|、
% |\ftmatrilineal|と同義。
% \end{longtable}
...
\setlength{\ft@cmarkbox@length}{1\ft@ch}
...
\setlength{\ft@optbox@indent}{1.1\ft@ch}
...
\setlength{\ft@namebox@sp}{.25\ft@ch}
\newcommand{\ft@namebox@font}{}% empty
\newlength{\ft@namebox@maleline@sp}
\setlength{\ft@namebox@maleline@sp}{.25\ft@ch}
\newlength{\ft@namebox@maleline@length}
\setlength{\ft@namebox@maleline@length}{1.5\ft@ch}
...
\setlength{\ft@titlebox@indent}{-.25\ft@ch}
